...
import type { DatabaseHealthStatus, HealthStatus } from "./api.schemas";
...
export const getDatabaseHealthCheckQueryKey = () => {
  return [`/api/db/healthz`] as const;
};

export const getDatabaseHealthCheckQueryOptions = <
  TData = Awaited<ReturnType<typeof databaseHealthCheck>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof databaseHealthCheck>>
  > = ({ signal }) => databaseHealthCheck({ signal, ...requestOptions });
...
export type DatabaseHealthCheckQueryResult = NonNullable<
  Awaited<ReturnType<typeof databaseHealthCheck>>
>;
export type DatabaseHealthCheckQueryError = ErrorType<unknown>;
